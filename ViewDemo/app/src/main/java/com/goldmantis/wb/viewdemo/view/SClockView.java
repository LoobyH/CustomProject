package com.goldmantis.wb.viewdemo.view;
...
/**
 * Created by 00027450 on 2018/3/28.
 */

public class SClockView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public SClockView(Context context) {
        this(context, null);
    }

    public SClockView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SClockView(Context context, AttributeSet attrs, int defStyleAttr) {
